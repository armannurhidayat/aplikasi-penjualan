      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="col-md-6 col-md-offset-3">
            <form action="<?= base_url('admin/barang/ubah') ?>" method="POST">
              ...
              <div class="form-group <?= form_error('nama_barang') ? 'has-error' : null ?>">
                ...
                <input name="nama_barang" id="nama_barang" type="text" class="form-control" autofocus="" value="<?= $barang['nama_barang'] ?>">
              ...
              <div class="form-group <?= form_error('harga_barang') ? 'has-error' : null ?>">
                ...
                <input name="harga_barang" id="harga_barang" type="number" class="form-control" value="<?= $barang['harga_barang'] ?>">
              ...
              <div class="form-group <?= form_error('stock_barang') ? 'has-error' : null ?>">
                ...
                <input name="stock_barang" id="stock_barang" type="number" class="form-control" value="<?= $barang['stock_barang'] ?>">
