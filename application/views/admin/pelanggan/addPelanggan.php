          ...
          <div class="col-md-6 col-md-offset-3">
            <form action="<?= base_url('admin/pelanggan/tambah') ?>" method="POST">
              ...
              <div class="form-group <?= form_error('nama_pelanggan') ? 'has-error' : null ?>">
                ...
                <input name="nama_pelanggan" id="nama_pelanggan" type="text" class="form-control" placeholder="Arman Nur Hidayat" autofocus="" value="<?= set_value('nama_pelanggan') ?>">
              ...
              <div class="form-group <?= form_error('alamat_pelanggan') ? 'has-error' : null ?>">
                ...
                <textarea name="alamat_pelanggan" id="alamat_pelanggan" cols="30" rows="10" class="form-control" style="resize: none"><?= set_value('alamat_pelanggan') ?></textarea>
